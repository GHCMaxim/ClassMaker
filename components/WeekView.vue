	...
	<div class="flex h-full flex-col">
		...
		>
			...
			>
				<div
					ref="containerNav"
					class="sticky top-0 z-30 flex-none bg-white shadow ring-1 ring-black/5 sm:pr-8"
				>
					<div
						...
						>
							...
							>
								...
								>
									...
									<p
										class="text-blue-500 group-hover:text-blue-700"
									>
							...
							>
								...
								>
									...
									<p
										class="text-pink-500 group-hover:text-pink-700"
									>
